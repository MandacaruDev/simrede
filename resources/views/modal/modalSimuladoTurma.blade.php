...
<div class="modal-header">
  ...
  <h4 class="modal-title"><strong>Relatório Geral Notas - Turma</strong></h4>
</div>
<div class="modal-body">

<form method='get' action='{{url("modal/simulado_turma_report")}}'>
...
<tr>
<td align="center">
<label >Selecione Turma:</label><br>
{!! Form::select('turma',  Config::get('enums.turmasim')) !!}</p>
</td>
</tr>
