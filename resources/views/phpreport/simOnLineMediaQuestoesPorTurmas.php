...
$PHPJasperXML->arrayParameter=  ["ano"=>$ano,"codsiem"=>$codsiem,"nivel"=>$nivel,"simulado"=>$simulado,"turma"=>$turma];

$PHPJasperXML->load_xml_file("/opt/lampp/htdocs/simrede/jrxmlreport/simOnLineMediaQuestoesPorTurma.jrxml");
