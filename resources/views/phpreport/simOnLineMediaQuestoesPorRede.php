...
$PHPJasperXML->arrayParameter=  ["ano"=>$ano,"nivel"=>$nivel,"simulado"=>$simulado];

$PHPJasperXML->load_xml_file("/opt/lampp/htdocs/simrede/jrxmlreport/simOnLineMediaQuestoesPorRede.jrxml");
